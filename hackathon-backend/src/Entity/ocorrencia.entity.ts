...
import { TipoOcorrencia } from "./tipoOcorrencia.entity";
...
class Ocorrencia {
    ...
    constructor(id: number, tipo: TipoOcorrencia, funcionario: Funcionario, patrimonio: Patrimonio, descricao: string, status: STATUS) {
      this.id = id;
      this.tipo = tipo;
